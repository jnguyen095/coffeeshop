  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <?php
        ...
        $show_admin_menu = $can_admin_tables_manage || $can_admin_court_time_slots || $can_admin_recipes || $can_admin_trung_thu || $can_admin_categories || $can_admin_products || $can_admin_inventory_categories
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <?php if ($can_admin_recipes): ?><li><a class="dropdown-item" href="<?php echo site_url('recipes'); ?>"><i class="bi bi-egg-fried"></i> Công thức pha chế</a></li><?php endif; ?>
            <?php if ($can_admin_trung_thu): ?><li><a class="dropdown-item" href="<?php echo site_url('trung-thu/admin'); ?>"><i class="bi bi-moon-stars"></i> Đăng ký quà Trung Thu</a></li><?php endif; ?>
