<div class="container-fluid py-3 py-md-4">
      ...
      <div class="col">
        <div class="month-day-cell rounded <?php echo $is_today ? 'is-today' : ''; ?> <?php echo $is_other_month ? 'is-other-month' : ''; ?>"
          ...
          <?php foreach (array_slice($day_bookings, 0, 3) as $b): ?>
            <div class="week-chip status-<?php echo strtolower($b['status']); ?> d-block mb-1"
              ...
              <?php echo substr($b['start_time'],0,5); ?> <?php echo htmlspecialchars(mb_strimwidth($b['table_code'], 0, 6, '')); ?>
            </div>
          <?php endforeach; ?>
          <?php if (count($day_bookings) > 3): ?>
            <div class="small text-muted">+<?php echo count($day_bookings) - 3; ?> khác</div>
          <?php endif; ?>
        </div>
      </div>
  ...
  <div class="small text-muted mt-2">
    ...
    — Bấm vào một ngày để xem chi tiết theo giờ
  </div>
</div>
